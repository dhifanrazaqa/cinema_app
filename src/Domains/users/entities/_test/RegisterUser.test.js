...
describe('a RegisterUser entities', () => {
  ...
  it('should throw error when age invalid', () => {
    // Arrange
    const payload = {
      username: 'asdrtyu',
      fullname: 'asdfghjk',
    ...
    // Action and Assert
    expect(() => new RegisterUser(payload)).toThrowError('REGISTER_USER.AGE_INVALID');
  });
  ...
  it('should create registerUser object correctly', () => {
    ...
    // Action
    const {
      username, fullname, password, age,
